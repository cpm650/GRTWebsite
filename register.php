...
<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if($error==0){
            ...
            fclose($fileout);
            $success='<h1 class="success">Get Excited!</h1><div class="wrapper subsection-wrapper" style="background-color:rgb(255,255,255)"><div class="subsection"><div class="sectionBody"><div class="bold center">You are now registered for the 2019 GRT summer camp!<br>We will email you to confirm your registration at a later date.</div><br>';
