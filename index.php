...
<body onload="initImgScroll()">
    ...
    <div class="wrapper" id="bodyContainer">
        <div class="wrapper" id="homeFocus">
            ...
            <font size="+2">A robotics team from Henry M. Gunn High School(Palo Alto, CA) competing since 1997 in the annual FIRST robotics FRC competition as Team 192.</font>
